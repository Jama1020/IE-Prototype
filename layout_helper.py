                ...
                children=[
                    html.A(
                        id='dashbio-logo', children=[
                            html.Img(style={'height':'5%', 'width':'5%'},
                                src='data:image/png;base64,{}'.format(
                                    base64.b64encode(
                                        open(
                                            'C:\\Users\\moren\\Desktop\\TODO JORGE\\Jorge Moreno\\IE\\Business Strategy and AI\\DASH\\BRAIN I\\assets\\dash-logo.png', 'rb'
                                        ).read()
                                    ).decode()
                                )
                            )],
                    ...
                    html.H2(
                        'DATADYNAMUS MOLECULE CLASSROOM'
                    ),
                    ...
                    html.Img(
                        src='data:image/png;base64,{}'.format(
                            base64.b64encode(
                                open(
                                    'C:\\Users\\moren\\Desktop\\TODO JORGE\\Jorge Moreno\\IE\\Business Strategy and AI\\DASH\\dash-molecule-3d-viewer\\assets\\GitHub-Mark-{}64px.png'.format(
